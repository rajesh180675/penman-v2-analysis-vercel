export const CapitalineMappingSpec = {
  ...
  profitLoss: {
    ...
    cogsInventoryChange: ["Changes in Inventories of Finished Goods, Work-in-Progress and Stock-in-Trade"],
    totalExpenses: ["Total Expenses"],
    employeeExpense: ["Employee Benefits / Salaries & other Staff Cost"],
    ...
    sgaAds: ["Advertisement, Marketing and Business Development", "Advertisements"],
    sgaLegal: ["Legal and Professional Fees", "Professional Fees", "Legal Expenses"],
    sgaRent: ["Rent", "Rent, rates & Taxes", "Lease Rent / Hire Charges Paid"],
    sgaFreight: ["Freight Outwards and Forwarding Expenses", "Transportation"],
    sgaRepairs: [
