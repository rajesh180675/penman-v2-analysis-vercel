  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm" data-testid="run-backed-portfolio-comparison">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div><h2 className="text-lg font-bold text-slate-800 dark:text-slate-100">Immutable-run portfolio comparison</h2><p className="mt-1 text-sm text-slate-500">Only policy-, schema-, date-, trust-, and range-comparable runs receive scores or allocation weights.</p></div>
