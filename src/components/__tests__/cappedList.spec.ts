/* ================================================================
   The display-window helper shared by the truncating panels.

   `capped` exists because `.slice(0, n)` on its own discards the
   number a reader needs in order to know they are looking at a
   subset. These pin the two halves it returns and the one thing it
   deliberately does not do, which is reorder.
================================================================ */
