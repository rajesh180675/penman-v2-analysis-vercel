  ...
  return (
    <div className="rounded-xl border border-slate-700 p-4 space-y-3">
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-semibold text-slate-200">Segment Intelligence</h3>
      ...
      {capitalAllocation && (
        <div className="text-xs space-y-1">
          <div className="flex items-center gap-2">
            <span className="text-slate-400">Allocation Quality:</span>
      ...
      {conglomerateDiscount && (
        <div className="text-xs space-y-1">
          <div className="flex items-center justify-between">
            <span className="text-slate-400">Conglomerate Discount</span>
            <span className={`font-bold ${
              conglomerateDiscount.verdict === 'premium' ? 'text-green-400' :
              conglomerateDiscount.verdict === 'fair' ? 'text-slate-300' :
          ...
          <p className="text-slate-400 italic">{conglomerateDiscount.narrative}</p>
        </div>
      )}
