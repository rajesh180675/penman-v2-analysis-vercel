 ...
 */
const NO_SCORECARD = "No valuation ran";
 ...
 *   null     + "No valuation ran"           — nothing was even attempted
 *
...
export function earningsQualityMetric(
  ...
  if (summary.totalScore == null) {
    // Two states reach here and only one of them attempted anything. A real card
    ...
    // send a reviewer looking for missing statement lines rather than for the
    // valuation that never ran.
    //
